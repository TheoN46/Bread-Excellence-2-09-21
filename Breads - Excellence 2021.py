...
def salads ():
    ...
    while True:
        ...
        quit = str(input("You have selecte: {} Type Y if thats all you want".format(salad_selected_list)))
        if quit == "y":
            break
...
def output_order():
    ...
    breadorder.append(breads_selected)
    breadorder.append(meats_selected)
    breadorder.append(cheese_selected)
    breadorder.append(salad_selected)
    breadorder.append(dressings_selected)
